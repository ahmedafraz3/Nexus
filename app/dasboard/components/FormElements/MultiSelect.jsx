    ...
    <div className="relative z-50">
      ...
      <div>
        ...
        <div className="flex flex-col items-center">
          <input name="values" type="hidden" defaultValue={selectedValues()} className="text-black" />
                    ...
                    {selected.length === 0 && (
                      <div className="flex-1">
                        <input
                          ...
                          className="h-full w-full appearance-none bg-transparent p-1 px-2 outline-none text-black"
